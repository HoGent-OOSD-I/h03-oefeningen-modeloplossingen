...
class ProductTestKort {
    ...
    void maakProduct_KortingStuksPercentageNetOK_MaaktProduct(int kortingPerc) {
    ...
    void maakProduct_KortingStuksPercentageNietOK_MaaktProductMetKortingStuksPercentage0(int kortingPerc) {
    ...
    void maakProduct_PrijsExclBtwNul_MaaktProductMetPrijs1(int prijs) {
    ...
    void setPrijsExlBtw_PrijsNietOK_WijzigtPrijsNiet(double prijs) {
        p2.setPrijsExclBtw(prijs);
    ...
    @Test
    void berekenPrijsMetBtw_ProductMetBtwPercentage21ZonderKortingt6Stuks_RetourneertPrijsMetBtw() {
