...
class ProductTest {
    ...
    @Test
    void maakProduct_NormaleData_MaaktProduct() {
    ...
    @Test
    void maakProduct_KortingStuksPercentageNetGrootGenoeg_MaaktProduct() {
    ...
    @Test
    void maakProduct_KortingStuksPercentageNetNietTeGroot_MaaktProduct() {
    ...
    @Test
    void maakProduct_KortingStuksPercentageNetTeKlein_MaaktProductMetKortingStuksPercentage0() {
    ...
    @Test
    void maakProduct_KortingStuksPercentageTeKlein_MaaktProductMetKortingStuksPercentage0() {
    ...
    @Test
    void maakProduct_KortingStuksPercentageNetTeGroot_MaaktProductMetKortingStuksPercentage0() {
    ...
    @Test
    void maakProduct_KortingStuksPercentageTeGroot_MaaktProductMetKortingStuksPercentage0() {
    ...
    @Test
    void maakProduct_BtwPercentageNetGrootGenoeg_MaaktProduct() {
    ...
    @Test
    void maakProduct_BtwPercentagePercentageNetNietTeGroot_MaaktProduct() {
    ...
    @Test
    void maakProduct_BtwPercentageNetTeKlein_MaaktProductMetBtwPercentage21() {
    ...
    @Test
    void maakProduct_BtwPercentageTeKlein_MaaktProductMetBtwPercentage21() {
    ...
    @Test
    void maakProduct_BtwPercentageNetTeGroot_MaaktProductMetBtwPercentage21() {
    ...
    @Test
    void maakProduct_BtwPercentageTeGroot_MaaktProductMetBtwPercentage21() {
    ...
    @Test
    void maakProduct_PrijsExclBtwNul_MaaktProductMetPrijs1() {
        Product p = new Product("Spa Bruis", 0, 20, 20);
        Assertions.assertEquals("Spa Bruis", p.getNaam());
        Assertions.assertEquals(Product.STANDAARDWAARDE_PRIJS, p.getPrijsExclBtw());
        Assertions.assertEquals(20, p.getBtwPercentage());
        Assertions.assertEquals(20, p.getKortingStuksPercentage());
    }

    @Test
    void maakProduct_PrijsExclBtwNegatief_MaaktProductMetPrijs1() {
    ...
    @ParameterizedTest
    @NullAndEmptySource
    void maakProduct_NaamNietGekend_MaaktProductMetNaamOnbekend(String naam) {
    ...
    @Test
    void setPrijsExclBtw_WijzigtPrijsExclBtw() {
        p2.setPrijsExclBtw(3.77);
        Assertions.assertEquals(3.77, p2.getPrijsExclBtw());
    }

    @Test
    void setPrijsExlBtw_PrijsPositief_SteltPrijsIn() {
        p2.setPrijsExclBtw(33.66);
        Assertions.assertEquals(33.66, p2.getPrijsExclBtw());
    }

    @Test
    void setPrijsExlBtw_PrijsNetPositief_SteltPrijsIn() {
        p2.setPrijsExclBtw(Double.MIN_VALUE);
        Assertions.assertEquals(Double.MIN_VALUE, p2.getPrijsExclBtw());
    }

    @Test
    void setPrijsExlBtw_Prijs0_WijzigtPrijsNiet() {
        p2.setPrijsExclBtw(0);
        Assertions.assertEquals(1.48, p2.getPrijsExclBtw());
    }

    @Test
    void setPrijsExlBtw_PrijsNegatief_WijzigtPrijsNiet() {
        p2.setPrijsExclBtw(-10.5);
        Assertions.assertEquals(1.48, p2.getPrijsExclBtw());
    }

    @Test
    void berekenPrijsMetBtw_ProductMetBtwPercentage21ZonderKortingStuks_RetourneertPrijsMetBtw() {
        Assertions.assertEquals(1.79, p1.berekenPrijs(1), 0.01);
    }

    @Test
    void berekenPrijsMetBtw_ProductMetBtwPercentage21MetKortingStuks_RetourneertPrijsMetBtw() {
